...
#convertir de xlsx a xls lunes-jueves
...
#convertir de xlsx a xls viernes-sabado
def convert_xlsx_to_xls_viernes_sabado(xlsx_file, xls_file):
    # Cargar el archivo .xlsx usando openpyxl
    wb_xlsx = openpyxl.load_workbook(xlsx_file)
    sheet_xlsx = wb_xlsx[wb_xlsx.sheetnames[1]]
    find_table_and_move_to_A5_xlsx_viernes_sabado(sheet_xlsx)
